"""
Spatial Zone Weighted Plot Generator — Without Occupancy Datasets
=================================================================
...
Weights Configuration:
  - Standard Datasets (Day 1 P1, Day 2 P1-P3):
      Tz   = 0.50*S1 + 0.30*S2 + 0.20*S3
      RHz  = 0.50*S1 + 0.30*S2 + 0.20*S3
      CO2z = 0.60*S2 + 0.40*S3
  - Faulty Sensor Exception (Day 2 P4 — S3 Off):
      Tz   = 0.60*S1 + 0.40*S2
      RHz  = 0.60*S1 + 0.40*S2
      CO2z = S2
"""
...
def process_dataset_weighted(cleaned_filename):
    ...
    print(f"Generating weighted plots for: {base_name}...")
    ...
    if "room_3_t" in df.columns and not is_day2_p4:
    ...
    if "room_3_h" in df.columns and not is_day2_p4:
    ...
    if "room_3_c" in df.columns and not is_day2_p4:
...
if __name__ == "__main__":
    ...
    print(f"Found {len(clean_files)} cleaned without_occ datasets to process.")
