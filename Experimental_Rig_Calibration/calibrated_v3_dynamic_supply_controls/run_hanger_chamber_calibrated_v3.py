...
PLOT_ZONE_TEMP_PATH = os.path.join(CALIBRATED_V3_DIR, "hanger_chamber_after_calibrated_v3.png")
PLOT_OUTDOOR_TEMP_PATH = os.path.join(CALIBRATED_V3_DIR, "calibrated_v3_outdoor_temp_verification.png")
PLOT_FLOW_RATE_PATH = os.path.join(CALIBRATED_V3_DIR, "calibrated_v3_flow_rate_verification.png")
...
def run_energyplus_iteration(params):
    ...
    temp_idf = os.path.join(CALIBRATED_V3_DIR, "temp_run.idf")
