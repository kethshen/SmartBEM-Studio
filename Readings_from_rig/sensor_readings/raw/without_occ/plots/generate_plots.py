"""
Seaborn Plotting Script — Raw Datasets (Without Occupancy)
=========================================================
Generates modern, publication-ready multi-subplot figures for raw sensor data.
...
PALETTE = {
    ...
    "S3":      "#F4A261",  # Lighter Soft Orange/Amber
...
# Adjusted Light Purple for Supply
PALETTE["Supply"] = "#9D4EDD"  # Crisp Light Purple

sns.set_theme(style="whitegrid", font="sans-serif")

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
RAW_WITHOUT_DIR = os.path.dirname(SCRIPT_DIR)
...
if __name__ == "__main__":
    csv_files = [f for f in os.listdir(RAW_WITHOUT_DIR) if f.endswith(".csv")]
    for f in sorted(csv_files):
        generate_seaborn_plot(os.path.join(RAW_WITHOUT_DIR, f))
