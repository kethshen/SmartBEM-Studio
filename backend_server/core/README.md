...
### 6. `material_dict_compiler.py` & `index.json`
...
### 7. `prompt_preprocessor.py`
- **Description:** Pre-processes raw natural language prompts.
- **Key Functions:**
  - Structures natural language instructions into standardized JSON formats for the geometry engine.
