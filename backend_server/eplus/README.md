...
> [!NOTE]
> This folder is placed directly inside `backend_server/` to serve as a local python module (`eplus`) so the FastAPI backend can import it directly. The primary copy and development guide are located in the [EnergyPlus utility/](../EnergyPlus%20utility/) folder at the root of the repository.
