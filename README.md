...
│   ├── assets/                   # Icons, images
│   ├── data/
│   │   └── weather_index.json    # Global EPW weather station database
│   └── pages/
...
│   │   ├── idf_extractor.py      # IDF file assembly
│   │   ├── visualizer.py         # Plotly chart generation from SQL results
│   │   ├── weather_resolver.py   # EPW file download & caching
...
│   │   └── hvac/                 # Modular HVAC IDF snippets
│   ├── eplus/
│   │   ├── eplus_util.py         # EnergyPlus Python utility library
...
│
├── EKF/                          # EKF research module
│   ├── Real_EKF.py               # EKF implementation
│   ├── EKF_System_Reference.md   # Mathematical reference document
│   └── Practise demos/
│
├── Datasets/                     # EnergyPlus object library (for RAG)
├── scripts/
│   └── build_weather_index.py    # Utility: regenerate web/data/weather_index.json
│
├── .gitignore
└── README.md
```
