...
class PromptStructurer:
    ...
    def restructure_prompt(self, raw_prompt, model_type="ollama"):
        ...
        system_prompt = (
            ...
            "- MISSING ZONE DETAILS: If specific wall constructions are not mentioned, set them to 'Medium Exterior Wall'. If no subsurfaces are specified, write 'subsurfaces: []'.\n"
